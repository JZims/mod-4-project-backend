...
Pet.create(name: "Courage", swag_total: 100, user_id: User.all.sample.id, image: "https://ibb.co/4pHqRNS")
Pet.create(name: "CatDog", swag_total: 100, user_id: User.all.sample.id, image: "https://ibb.co/2dwNVX9")
Pet.create(name: "Snorlax", swag_total: 100, user_id: User.all.sample.id, image: "https://ibb.co/MMkt7YL")
Pet.create(name: "Simba", swag_total: 100, user_id: User.all.sample.id, image: "https://ibb.co/4m3B9Xz")
Pet.create(name: "Rocco", swag_total: 100, user_id: User.all.sample.id, image: "https://ibb.co/HpysyWV")
Pet.create(name: "Darkwing Duck", swag_total: 100, user_id: User.all.sample.id, image: "https://ibb.co/JkHBG0m")
Pet.create(name: "Porkchop", swag_total: 100, user_id: User.all.sample.id, image: "https://ibb.co/561dS8h")
Pet.create(name: "Reptar", swag_total: 100, user_id: User.all.sample.id, image: "https://ibb.co/dDbq9pf")
Pet.create(name: "Lickitung", swag_total: 100, user_id: User.all.sample.id, image: "https://ibb.co/3CChMYF")
Pet.create(name: "Alpha", swag_total: 100, user_id: User.all.sample.id, image: "https://ibb.co/Bg88bY3")
